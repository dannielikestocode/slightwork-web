...
::: tip 📝 Note
Further documentation on manifest files available here: [Manifest Files](https://developer.salesforce.com/docs/platform/sfvscode-extensions/guide/manifestbuilder.html)
:::
...
Sometimes, the simplest option is the best option. This method is ideal for getting started quickly with SlightWork without the need for a full SFDX project setup.
...
::: tip 🔜 Coming Soon!
Plans are being drafted to provide unlocked packages for easy installation of SlightWork modules into your Salesforce org.
:::