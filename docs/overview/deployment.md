...
Use the <code>sf project deploy start</code> command to deploy assets using a manifest file. You'll need to include the <code>--manifest</code> argument to specify the name of the manifest file you want to deploy.
